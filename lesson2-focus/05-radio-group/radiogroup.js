  ...
  RadioGroup.prototype.handleKeyDown = function(e) {
    switch(e.keyCode) {
      ...
      case VK_LEFT: {
        ...
        this.focusedIdx = this.focusedIdx - 1 < 0 ? this.buttons.length - 1 : this.focusedIdx - 1;
        break;
      ...
      case VK_RIGHT: {
        ...
        // This seems like a good place to do some stuff :)
        this.focusedIdx = this.focusedIdx + 1 > this.buttons.length - 1 ? 0 : this.focusedIdx + 1;
        break;
      }
